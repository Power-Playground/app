...
let editor: Editor<TypeScriptPluginX>
if (import.meta.hot?.data['typescript:editor']) {
  editor = import.meta.hot.data['typescript:editor']
} else {
  editor = {
    use,
    useShare({
  ...
  if (import.meta.hot) {
    import.meta.hot.data['typescript:editor'] = editor
  }
}
